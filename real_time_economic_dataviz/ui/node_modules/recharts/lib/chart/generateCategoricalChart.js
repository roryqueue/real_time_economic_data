  ...
  var CategoricalChartWrapper = (_temp = _class = function (_Component) {
    ...
    function CategoricalChartWrapper(props) {
      ...
      _this.handleMouseEnter = function (e) {
        ...
        var mouse = _this.getMouseInfo(offset, ne);
      ...
      _this.state = _extends({}, defaultState, _this.updateStateOfAxisMapsOffsetAndStackGroups(_extends({ props: props }, defaultState)));
      _this.validateAxes();
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.data !== data || nextProps.children !== children || nextProps.width !== width || nextProps.height !== height || nextProps.layout !== layout || nextProps.stackOffset !== stackOffset || nextProps.margin !== margin) {
          var defaultState = this.createDefaultState(nextProps);
          this.setState(_extends({}, defaultState, this.updateStateOfAxisMapsOffsetAndStackGroups(_extends({ props: nextProps }, defaultState))));
        }
        // add syncId
      ...
      */
      ...
      key: 'getMouseInfo',
      value: function getMouseInfo(offset, e) {
      ...
      value: function calculateOffset(props, graphicalItems, xAxisMap, yAxisMap) {
        ...
        offset = (0, _CartesianUtils.appendOffsetOfLegend)(offset, graphicalItems, props);
